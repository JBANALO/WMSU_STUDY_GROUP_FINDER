        ...
        <div style="background: white; padding: 0; border-radius: 10px; border: 3px solid #8B0000; box-shadow: 0 4px 6px rgba(0,0,0,0.1); height: 700px; display: flex; flex-direction: column; overflow: hidden;">
            ...
            <div style="padding: 15px 20px; border-top: 1px solid #e8e8e8; background: white; flex-shrink: 0;">
                ...
                <div style="display: flex; gap: 8px; align-items: flex-end;">
                    <label title="Note: Uploaded files are temporary and may be deleted during system updates" style="cursor: pointer; padding: 0; background: #999; color: white; border: none; border-radius: 50%; font-size: 16px; display: flex; align-items: center; justify-content: center; width: 44px; height: 44px; flex-shrink: 0; transition: background 0.2s; position: relative;" onmouseover="this.style.background='#777'" onmouseout="this.style.background='#999'">
                        <i class="fas fa-paperclip"></i>
                        <input type="file" id="fileInput" style="display: none;" accept="image/*,.pdf,.doc,.docx,.xls,.xlsx" disabled>
                        <span style="position: absolute; top: -2px; right: -2px; background: #dc3545; color: white; border-radius: 50%; width: 16px; height: 16px; font-size: 10px; display: flex; align-items: center; justify-content: center; font-weight: bold;">!</span>
                    </label>
